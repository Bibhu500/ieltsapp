  ...
  return (
    ...
    <div className="container mx-auto px-4">
      <div className="text-center py-8">
        <h2 className="text-2xl font-bold mb-2">Sure 8+ bands In IELTS</h2>
        <h6 className="mb-4">If you're targeting 8 or higher bands on the IELTS, this learning plan is tailor-made for you!...</h6>
      </div>
      <h3 className="text-xl font-bold mb-4">30 Modules</h3>
      <div>
        {coursesData.map((course, index) => (
          <CourseModule key={index} module={course} index={index} />
        ))}
...
export default Band8topiccontainer;
