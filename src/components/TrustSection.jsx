...
function TrustSection() {
  ...
  useEffect(() => {
    ...
    const transactionsCountInterval = setInterval(() => {
      if (transactionsCount < 500) {
        setTransactionsCount(transactionsCount + 0.1);
      } else {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <p className="font-medium text-4xl text-purple-600 dark:text-purple-500">Trusted Worldwide</p>
      <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
        ...
        <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
          ...
          <div>
            ...
            <p className="font-light text-gray-500 dark:text-gray-400">Trusted by over 600 million users around the world</p>
          </div>
          <div>
          ...
          <div>
            ...
            <h3 className="mb-2 text-2xl font-bold dark:text-white">{transactionsCount.toLocaleString()}+ Million</h3>
